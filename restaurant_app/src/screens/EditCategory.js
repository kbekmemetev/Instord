...
import {getCategories, updateCategory} from "../http/categoryAPI";
...
const EditCategory = observer(({navigation, catName, catParent, catId, route}) => {
    
    const {user} = useContext(Context)

    const [categoryName, setCategoryName] = useState(route.params.name)
    const [selectedCategory, setSelectedCategory] = useState(route.params.parent)
    ...
    return (
        ...
        <View style={styles.container}>
            <Formik
                ...
                onSubmit={
                async (values) => {
                    const data = updateCategory(categoryName, selectedCategory, route.params.category_id)
